# Generated by Django 2.0 on 2017-12-31 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('announcement', models.ForeignKey(on_delete='', related_name='comments', to='courses.Announcement', verbose_name='Anúncio')),
                ('user', models.ForeignKey(on_delete='', to=settings.AUTH_USER_MODEL, verbose_name='usuário')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('course', models.ForeignKey(on_delete='', related_name='enrollments', to='courses.Course', verbose_name='Curso')),
                ('user', models.ForeignKey(on_delete='', related_name='enrollments', to=settings.AUTH_USER_MODEL, verbose_name='Usuário')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('course', models.ForeignKey(on_delete='', related_name='lessons', to='courses.Course', verbose_name='Curso')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete='', related_name='materials', to='courses.Lesson', verbose_name='Aula')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete='', related_name='announcements', to='courses.Course', verbose_name='Curso'),
        ),
